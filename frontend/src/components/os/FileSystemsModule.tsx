...
import { Terminal, Folder, Settings } from 'lucide-react';
import { FaLinux } from 'react-icons/fa';

interface FileSystemTopic {
  name: string;
  details: string;
...
interface FileSystemModuleProps {
  topics: Array<FileSystemTopic>;
  responsibilities: string[];
}

const FileSystemsModule: React.FC<FileSystemModuleProps> = ({
  topics,
  responsibilities,
}: FileSystemModuleProps) => {
    ...
    <div className="container mx-auto p-4 max-w-6xl">
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        <div className="bg-gray-100 p-4 border-b flex items-center">
          ...
          <h2 className="text-2xl font-bold text-gray-800">File Systems</h2>
        </div>
